...
namespace TeoGames.Mesh_Combiner.Scripts.Editor.MenuItems {
	public class GameObject : AssetModificationProcessor {
		...
		[MenuItem("GameObject/Dynamic Mesh Combiner/Mark all meshes as Read-Write", false, 400)]
		public static void MarkAsReadable() => Selection.gameObjects.ForEach(o => Utils.SetReadableStatus(o, true));

		[MenuItem("GameObject/Dynamic Mesh Combiner/Unmark all meshes as Read-Write", false, 401)]
		public static void UnmarkAsReadable() => Selection.gameObjects.ForEach(o => Utils.SetReadableStatus(o, false));
